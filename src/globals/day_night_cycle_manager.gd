...
func set_initial_time() -> void:
	var total = initial_day * MINUTES_PER_DAY + initial_hour * MINUTES_PER_HOUR + initial_minute
	time = total * GAME_MINUTE_DURATION
...
func recalculate_time() -> void:
	...
	var hour: int = int(rem / MINUTES_PER_HOUR)
	var minute: int = rem % MINUTES_PER_HOUR
